 ...
 * @param confidenceIntervals     95% confidence interval per node [lower, upper]
 * @param expectedCascadeSize     average number of affected nodes per run
 * @param weightedExpectedImpact  average weighted impact per run (using importanceWeight)
